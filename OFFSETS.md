...
Паттерн для Поиска Codegenreg + Metadatareg или как там крч - ?? ?? ?? 90 21 ?? ?? F9 ?? ?? ?? D0 ?? ?? ?? 90 00 ?? ?? 91 42 ?? ?? 91 ?? ?? ?? 14 (кодерег метарег.пнг) паттерн подходит для любой версии и любых игр в целом я думаю
